...
|/postclosingtoday|Posts a list of IPOs closing today, if any. Can only be run from the [control group](https://github.com/desmond27/IPONewsBot#note-on-control-groups).|
